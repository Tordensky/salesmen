...
/*
 * Removes the first element from the given list that compares equal
 * to the given element.
 * 
 * Returns the number of elements that were removed (0 or 1).
 */
 ...
 * list iterator. (And do NOT move the iter to next node in list)
 */
void *list_peek(list_iter_t *iter);
